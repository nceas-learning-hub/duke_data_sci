...
Quarto and RMarkdown are excellent ways to generate literate analysis and a reproducible workflow. These types of files combine R the programming language and **markdown, a set of text formatting directives**.
