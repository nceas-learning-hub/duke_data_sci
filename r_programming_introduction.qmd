...
-   `snake_case`
-   `camelCase` is compact but less readable
-   `UpperCamelCase` (also called `PascalCase`) sometimes signals a different kind of object
-   `kebab-case` is not good for object names because R treats a hyphen (`-`) as a minus sign
...
Programming comes with an implicit contract: the computer handles the tedious work, and you provide precise instructions. Typos and capitalization matter, and small differences can change the meaning entirely. Treat R as a language... misunderstandings will happen.

When R can’t interpret what you’ve written, you’ll get an error. Some errors are straightforward, essentially asking “What?” or pointing to exactly where the problem is. Others are less helpful. Either way, they’re part of the process and a normal part of learning to communicate clearly with the computer.

:::
:::::


Error messages are a learning opportunity. Copy and paste them into Google (or ChatGPT) to see what they mean. Note that knowing how to Google is a skill and takes practice. This [Masters of Environmental Data Science](https://bren.ucsb.edu/masters-programs/master-environmental-data-science) (MEDS) program workshop [Teach Me How to Google](https://ucsb-meds.github.io/teach-me-how-to-google/#1) has a very helpful guide.

Some mistakes don't trigger errors right away. R may understand what you wrote, but not what you intended... much like talking about "tables" and realizing too late that the listener was picturing furniture instead of data. These misunderstandings accumulate and make later results confusing.  Writing clear code and checking your work step by step helps prevent these silent errors and keeps your analysis on track.
