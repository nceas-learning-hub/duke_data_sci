...
In this course, we will use an R project to organize our work. An R project is tied to a directory on your local computer, and makes organizing your work and collaborating with others easier.

**The Big Idea:** using an R project is a reproducible research best practice because it bundles all your work within a working directory. 
...
For this series we are going to create 3 folders (directories) in our `training_{USERNAME}` Rproject.
